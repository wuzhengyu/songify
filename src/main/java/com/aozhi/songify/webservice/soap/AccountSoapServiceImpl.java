...
@WebService(serviceName = "AccountService", endpointInterface = "com.aozhi.songify.webservice.soap.AccountSoapService", targetNamespace = WsConstants.NS)
...
public class AccountSoapServiceImpl implements AccountSoapService {
	...
	public IdResult createUser(UserDTO user) {
		...
		try {
			...
			accountService.registerUser(userEntity);
